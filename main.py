...
def show_post(post_id):
    ...
    if comments.validate_on_submit():
        if current_user.is_authenticated:
            new_comment = Comment(
                text=comments.comment_text.data,
            ...
            flash("You need to login first, in order to comment.")
            return redirect(url_for("login"))

    return render_template("post.html", post=requested_post, logged_in=current_user, comments=comments)
